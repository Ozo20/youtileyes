  ...
  if (!tenant) {
    return (
      <div className="page-container">
        <PageHeader title="Qualifications" description="No tenant found." />
      </div>
    );
  }
  ...
  return (
    <div className="page-container">
      <PageHeader
        ...
        description="Reusable competence definitions for staffing and instructor eligibility."
        actions={
          <Badge tone="info">
          ...
          <CardContent className="master-list-content">
            <MasterDataList
              ...
              items={qualifications.map((qualification) => ({
                id: qualification.id,
                href: `/qualifications?id=${qualification.id}`,
        ...
        {creating || selected ? (
          ...
          <Card className="master-detail-card master-empty-detail">
            <EmptyState
              ...
              title="Select a qualification"
              description="Open a qualification to edit the competence catalogue."
            />
          </Card>
        )}
      </div>
